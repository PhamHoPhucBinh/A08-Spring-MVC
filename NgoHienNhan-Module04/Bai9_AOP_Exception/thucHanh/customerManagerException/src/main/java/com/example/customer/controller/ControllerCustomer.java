...
import com.example.customer.NameNotNullException;
...
public class ControllerCustomer {
    ...
    public ModelAndView showAll(@PageableDefault(value = 5) Pageable pageable) throws Exception {
    ...
    public String create(@ModelAttribute Customer customer, RedirectAttributes redirectAttributes) throws Exception{
        if (customer.getName() == ""){
